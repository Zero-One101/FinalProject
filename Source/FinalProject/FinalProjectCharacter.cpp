...
{ 
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			...
			World->SpawnActor<AFinalProjectProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
		}
	}
...
void AFinalProjectCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
bool AFinalProjectCharacter::EnableTouchscreenMovement(class UInputComponent* InputComponent)
{
	bool bResult = false;
	if(FPlatformMisc::GetUseVirtualJoysticks() || GetDefault<UInputSettings>()->bUseMouseForTouch )
	{
		bResult = true;
		InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AFinalProjectCharacter::BeginTouch);
		InputComponent->BindTouch(EInputEvent::IE_Released, this, &AFinalProjectCharacter::EndTouch);
		InputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AFinalProjectCharacter::TouchUpdate);
	}
	return bResult;
}
